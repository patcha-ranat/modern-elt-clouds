...
DAG_ID = "ingestion_pipeline_mongodb_s3"

# Default DAG Configuration
default_config = {
    "dlt_pipeline_name": "extract_load_mongodb_s3",
...
s3_bucket: dict = Variable.get("s3", deserialize_json=True)
...
with DAG(
    ...
    dlt_pipeline = dlt.pipeline( # ValueError: Please create your Pipeline instance after AirflowTasks are created.
        ...
        dataset_name="mongodb", # data lake subpath
